        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div variants={item}>
              ...
              <h3 className="text-2xl font-kanteiryuu mb-3">国産石臼挽き蕎麦粉の手打ち・手切り蕎麦</h3>
              <p className="text-gray-600 mb-4 font-kanteiryuu">
                北海道、栃木、茨城など、季節ごとに最良の産地を厳選した国産石臼挽きの蕎麦粉を使用。一本一本丁寧に手打ち・手切りで仕上げます。香り高い「十割蕎麦」と、江戸前の喉越しを堪能できる「二八蕎麦」の二種類をご用意。昔ながらの製法で仕込むかえしに、鰹節とサバ節を効かせた風味豊かな自家製つゆも自慢です。
              </p>
            </motion.div>
