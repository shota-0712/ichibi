...
const meta = {
  '/': {
    title: '十割蕎麦・創作酒場 一期一美 |千葉県君津市の手打そば・定食・天ぷら',
    description: '千葉県君津市にある「一期一美」は、手打ち十割蕎麦や天ぷら、生姜焼きや親子丼などの各種定食を楽しめるランチと、季節の一品料理を提供するお店です。',
    canonical: `${BASE_URL}/`
  },
  '/menu': {
  ...
  '/contact': {
    title: 'お問い合わせ・ご要望｜十割蕎麦・創作酒場 一期一美 |千葉県君津市の手打そば・定食・天ぷら',
    description: '店舗へのお問い合わせやご意見・ご要望、メニューに関するご質問などはこちらから。',
    canonical: `${BASE_URL}/contact`
  },
  '/dining-philosophy': {
    title: '料理のこだわり｜十割蕎麦・創作酒場 一期一美 |千葉県君津市の手打そば・定食・天ぷら',
